# Generated by Django 5.1.6 on 2025-02-16 18:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_leiloeiro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_leilao.leiloeiro')),
            ],
        ),
        migrations.CreateModel(
            name='matricula',
            fields=[
                ...
                ('id_estado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_leilao.estado')),
                ('id_leiloeiro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_leilao.leiloeiro')),
            ],
        ),
    ]
